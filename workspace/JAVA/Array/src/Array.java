...
public class Array {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < mascotas.length; i++) {
			mascotas[i] = generarNombre(); //aqui estamos invocando al método
		}

		// Escupimos los valores de cada posición del array
		for (int i = 0; i < mascotas.length; i++) {
			System.out.println("El nombre de la mascota es: " + mascotas[i]);
		}

		// También lo podríamos hacer con un for tipo "forEach"
		...
		// vAMOA CREAR UN MÉTODO PARA CREAR NOMBRES PARA LAS MASCOTAS DE MANERA
		// ALEATORIA UNIENDO DOS PALABRAS.
		// Definimos un nuevo método

	public static String generarNombre() {// generarNombre es un método, es como si fuera una funcón dentro de la
											// clase, le indicamos que nos va a devolver un valor tipo String (return), en caso contrario dará error
		...
		return nombreADevolver; //nombreADevolver es un tipo String, en caso contrario nos daría error.
	}
