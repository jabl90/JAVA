...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("Edad: "+pepito.edad+" años");
		 */

		System.out.println(pepito.getDatosCompletos()); // nos devuelve el valor que nos devuelve el método.
