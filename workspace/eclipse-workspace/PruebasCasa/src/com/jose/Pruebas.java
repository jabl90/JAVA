...
import java.util.*;
import java.text.DecimalFormat; // La tenemos que importar copiando esta linea de código, 
...
public class Pruebas {
	...
	public static void main(String[] args) {
		...
		int suma = a + b + c;
		// Los resultados tambien se podrían mosstrar guardando la operación en una
		// variable.
		...
		// Como las operaciones a realizar a continuación son mas complejas, vamos a
		...
		A++; // vale 'g', y en la proxima linea valdrá 'h';
		--B; // disminuye un valor, 'd';
		System.out.println(B++); // imprime 'd' y lo aumenta a 'e' para la próxima linea
		...
		System.out.println(m + " - " + N + " = " + numberFormat.format(m - N)); // accedemos al método que nos permite
																				// ajustat el número de decimales
		System.out.println("Valor numérico del carácter " + C + " = " + (int) C); // Poniendo delante la palabra
		...
		Scanner sp = new Scanner(System.in); // Tenemos que crear otro objeto diferente cuando cambiamos el tipo de
												...
												// si utliasemos el objeto sc, no nos dejaría introducir nada en la
												// consola
		String nombre;
