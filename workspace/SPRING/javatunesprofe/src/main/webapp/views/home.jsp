...
<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/style.css" type="text/css" />
		...
		<nav>
			...
			<div class="menu">
				<ul>
					...
					<li><a href="#">Cart</a></li>
					<li><a href="${pageContext.request.contextPath}/content/create">Create</a></li>
