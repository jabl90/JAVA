		...
		<section id="main">
			...
			<section id="singlecol">
				<article>
					...
					<form:form modelAttribute="MusicItem">
                           Title: <form:input size='20' path='title' /> <br>
                           Artist: <form:input size='20' path='artist' /><br>
                           Price: <form:input size='20' path='price' /> 	<br>			     
                           Category Search: <form:select path="musicCategory" items="${categories}" />
